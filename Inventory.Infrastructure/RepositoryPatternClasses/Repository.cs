...
namespace Inventory.Infrastructure.RepositoryPatternClasses
{
        ...
        where TEntity : class, IEntity<TKey>
    {
        ...
        public async Task<IList<TKey>> GetAllIdsAsync(Expression<Func<TEntity, bool>> filter = null, CancellationToken cancellationToken = default)
        {
            var query = _dbSet.AsQueryable();
            ...
            // Select the Id property and return as a list of TKey
