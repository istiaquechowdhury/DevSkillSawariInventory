...
namespace DevSkill.Inventory.Web.Areas.Admin.Controllers
{
    ...
    public class StockController : Controller
    {
        ...
        IStockListManagementService stockListManagementService, IWareHouseManagementService wareHouseManagementService, IProductManagementService productManagementService)
        {
        ...
        //    var result = await _stockListManagementService.GetStockListsSP(model.PageIndex, model.PageSize, model.SearchItem, model.FormatSortExpression("Product", "Warehouse", "InHand", "WeightedAvgCost"));
        //    var Stocklistjsondata = new
        //    {
        //        recordsTotal = result.total,
        //        recordsFiltered = result.totaldisplay,
        ...
        //                 HttpUtility.HtmlEncode(record.InHand),
        //                 HttpUtility.HtmlEncode(record.WeightedAvgCost.ToString("F2")), // Ensures decimal formatting
