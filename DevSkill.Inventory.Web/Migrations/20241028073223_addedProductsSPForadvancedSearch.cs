...
{
    /// <inheritdoc />
    public partial class addedProductsSPForadvancedSearch : Migration
    {
        /// <inheritdoc />
            ...
            var sql = """
                ...
                BEGIN
                	...
                	SET @countsql = 'select @TotalDisplay = count(*) from Products p inner join 
            					...
            					-- Collecting Data
            					SET @sql = 'select p.Id,p.ItemName,p.Barcode,c.Name as CategoryName from Products p inner join 
                       			Categories c on p.CategoryId = c.Id where 1 = 1 ';
